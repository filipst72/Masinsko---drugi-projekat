...
class NN:
    def __init__(self, input_size=108, hidden_size1=128, hidden_size2=64, output_size=7, device='cpu'):
        self.device = device
        self.W1 = th.zeros(input_size, hidden_size1, device=device)
        self.W2 = th.zeros(hidden_size1, hidden_size2, device=device)
        self.W3 = th.zeros(hidden_size2, output_size, device=device)
